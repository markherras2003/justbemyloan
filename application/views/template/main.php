...
<head>
<title>JBML - Just Be My Loan System</title>
<!-- Favicon -->
...
<link type="text/css" href="<?php echo base_url(); ?>public/bootstrap/bootstrap.min.css" rel="stylesheet" />

<!-- jQuery -->
<script type="text/javascript" src="<?php echo base_url() ?>public/jquery/jquery-1.6.4-min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>public/bootstrap/bootstrap.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url() ?>public/jquery/plugins/jquery.tablesorter.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>public/jquery/plugins/jquery.tablesorter.pager.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>public/jquery/plugins/jquery.tablesorter.widgets.js"></script>
	...
	<div id="content">
		<div id="contentHeader">
			<div id="header-wrapper">
				<div id="nslogo"></div>
				<div id="appTitle">Just Be My Loan MIT 202 Project</div>
		...
		<div id="contentFooter">Copyright 2019 . JBML System MIT 202
		</div>
	</div>
</body>
</html>
